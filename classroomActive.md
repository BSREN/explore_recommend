# Mo-AI 俱乐部第 58 期机器学习学术沙龙邀请函

Mo 人工智能俱乐部正式向感兴趣的小伙伴们发出诚挚的邀请！09月06日（周日），我们将在线上举办第 56 期机器学习学术沙龙。

+ 活动主题：联邦学习的隐私保护问题
+ 活动举办方：Mo人工智能俱乐部
+ 活动方式：线上（Mo平台直播&钉钉直播)
+ 活动时间：09月06日19：30-20：30
...
陈莫 浙江大学博士
#### 分享论文
从安全多方计算、同态加密、差分隐私三个角度讨论联邦学习的隐私保护问题，每个方法选取典型的1~2篇论文进行具体说明。
#### 大纲
1.安全多方计算
2.同态加密
3.差分隐私
#### 引言
联邦学习是一种新兴的机器学习方案。与传统的集中式机器学习不
同，联邦学习通过将训练任务下放到用户侧，仅将训练得到的模型参
数结果发送给服务端，从而使数据保持在用户本地，保证了用户数据
的隐私。然而，联邦学习并不是绝对安全的。近期的一些研究表明，
恶意的用户可以依据联邦学习梯度参数在每一轮中的差异，通过调整
其输人数据逼近真实梯度，从而推测出用户的敏感数据。本期讨论将
从安全多方计算、同态加密、差分隐私等方面来具体阐述联邦学习在
隐私保护中的研究进展。
### 活动地址
钉钉扫码，加入直播群！
...
|41|20.05.17|【论文分享】Towards Universal Representation Learning for Deep Face Recognition|[Universal Representation Learning](https://momodel.cn/live/5ec0ebb6b34e8b80a5eebabb)<br/>|
